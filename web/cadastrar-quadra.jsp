<%-- 
    Document   : cadastrar-quadra
    Created on : 17/12/2020, 19:03:59
    Author     : Leonardo
--%>
    ...
    <body>
        <section class="bg-light">
            <div class="text-center pb-0"><br/>
                <h2 class="section-heading text-uppercase">Cadastro de Quadra</h2>
                <h5 class="section-subheading">Utilize o formulário abaixo para cadastrar uma nova quadra.</h5>
                <p>*É necessário que o setor esteja cadastrado.</p>
            </div>
