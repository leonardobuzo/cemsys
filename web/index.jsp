<%-- 
    Document   : index
    Created on : 04/11/2020, 19:44:31
    Author     : Leonardo
--%>
...
<html lang="pt-BR">
    ...
    <body id="page-top">
        ...
        <header class="masthead" id="home">
            <div class="container">                
                <div class="masthead-subheading">Seja bem-vindo!</br>Insira o nome de quem deseja encontrar:</div>
                <form>
                    <input class="form-control align-items-center text-center text-uppercase " id="name" type="text" required="required" data-validation-required-message="Please enter your name." />
                    <br/>
                    <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="#services">Pesquisar</a>
                </form>
            </div>
        </header>
        <!-- Services-->
        ...
        <section class="page-section" id="contact">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">Qualquer dúvida ou reclamação estamos à disposição.</h3>
                </div>
