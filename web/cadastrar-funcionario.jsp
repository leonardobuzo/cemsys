<%-- 
    ...
    Created on : 17/12/2020, 19:05:08
    Author     : Leonardo
--%>
    ...
    <body>
        <section>
            <div class="text-center">
                <h2 class="section-heading text-uppercase">Cadastro de Funcionários</h2>
                <h5 class="section-subheading">Utilize o formulário abaixo para cadastrar um novo funcionário.</h5>
                <p>Ele terá acesso aos cadastros de falecidos, setores, quadras e lotes.</p>
            </div></br>
